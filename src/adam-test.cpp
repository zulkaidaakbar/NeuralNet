...
void Neuron::updateInputWeights(Layer &prevLayer)
{
	...
	for(unsigned n = 0; n < prevLayer.size(); ++n)
	{
		...
		neuron.m_outputWeights[m_myIndex].weight = neuron.m_outputWeights[m_myIndex].weight - eta*pow(0.9,1.0*epoch/450000.0)*(vdw_corrected / (sqrt(sdw_corrected) + epsilon));
	}
}
...
int main()
{
	TrainingData trainData("rnd_test2.txt");
	//e.g., {3, 2, 1 }
